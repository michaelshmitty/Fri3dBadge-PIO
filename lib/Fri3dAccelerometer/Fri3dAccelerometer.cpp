...
bool Fri3dAccelerometer::getEvent(sensors_event_t *event)
{
    return adxl345.getEvent(event);
}

void Fri3dAccelerometer::displaySensorDetails(void)
{
    sensor_t sensor;
...
void Fri3dAccelerometer::displayDataRate(void)
{
...
void Fri3dAccelerometer::displayRange(void)
{
    Serial.print("Range:         +/- ");
