...
bool Fri3dButtons::getBootButton()
{
    return 1 - digitalRead(BUTTONBOOT_PIN);
}

bool Fri3dButtons::getButton(int button)
{
    if (button == 0)
...
int Fri3dButtons::getTouchpad(int touchpad)
{
    if (touchpad == 0)
...
void Fri3dButtons::debounceButton(int button)
{
...
int Fri3dButtons::getDebouncedState(int button)
{
    return state[button];
}

void Fri3dButtons::setPressedCallback(int button, void (*callback)())
{
    pressedCallbacks[button] = callback;
}

void Fri3dButtons::setReleasedCallback(int button, void (*callback)())
{
